...
the author states in this chapter not to do this.. example( <=, >=, !=), but
VSCode automatically combines these operators
"""

# Sample Python/Pygame Programs
# http://programarcadegames.com/

# Explanation video: https://www.youtube.com/watch?v=pDpNSck2aXQ
...
# Use = if you are assigning a value.
if a == b:
...
# because the input will contain an extra carriage return at the end.
# It works fine under IDLE.
